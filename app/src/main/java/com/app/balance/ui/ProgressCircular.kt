...
class ProgressCircular @JvmOverloads constructor(
    ...
    private var porcentajeAhorroDisponible = 100f // Porcentaje de ahorro disponible del balance total
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Pintar el círculo COMPLETO con el color según el ahorro
        ...
        // SOLO MOSTRAR EL PORCENTAJE DE AHORRO
        paintText.color = 0xFF000000.toInt()
        paintText.textSize = 80f
        canvas.drawText("${porcentajeAhorroDisponible.toInt()}%", centerX, centerY + 25f, paintText)

        // Texto descriptivo
        paintText.textSize = 24f
        paintText.color = 0xFF666666.toInt()
        paintText.typeface = android.graphics.Typeface.DEFAULT
        canvas.drawText("ahorro disponible", centerX, centerY + 60f, paintText)
    }
